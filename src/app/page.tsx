...
const LightningBolt = () => {
  ...
  useEffect(() => {
    const generatePath = () => {
      ...
      // Multi-segment logic for jagged electric look (8 segments as requested)
      const segments = 8;
      ...
      <div className="fixed inset-0 z-10 overflow-hidden pointer-events-none">
        ...
        >
          <div className="text-center relative flex flex-col items-center">
            ...
            {/* TAGLINE & SOCIALS - Returned to original position */}
            <div className="mt-8 flex flex-col items-center">
              ...
              >
                  {/* Instagram Button */}
                  <motion.a 
                    whileHover={{ scale: 1.1, backgroundColor: "rgba(196, 27, 253, 0.1)" }}
                    whileTap={{ scale: 0.9 }}
                    href="https://www.instagram.com/mixaura__?igsh=cGdtdGJoZzRoNXk0" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="p-3 rounded-full border border-accent/20 text-accent transition-all duration-300 backdrop-blur-sm shadow-[0_0_15px_rgba(196,27,253,0.1)] hover:shadow-[0_0_20px_rgba(196,27,253,0.3)]"
                  >
