        ...
        {scene === 5 && (
          ...
          >
            <div className="flex flex-col items-center md:items-start gap-4 text-center md:text-left translate-y-[15%]">
              ...
              >
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-white/10 flex items-center justify-center border border-white/20">
                  <Hotel className="text-accent w-6 h-6 md:w-8 md:h-8" />
                </div>
                <h2 className="text-4xl sm:text-5xl md:text-7xl font-black tracking-[4px] md:tracking-[8px] text-white uppercase leading-none">
                  JEWEL <span className="text-accent">HOTEL</span>
                </h2>
              </motion.div>
              ...
              <motion.p
                ...
                className="max-w-xl text-[10px] md:text-[12px] font-code text-white uppercase tracking-[0.4em] md:tracking-[0.6em] leading-loose"
              >
                Strategic Partnership: Elevating luxury hospitality through cutting-edge digital experiences and immersive visual storytelling.
              </motion.p>
          ...
          >
            <div className="flex flex-col items-center md:items-start gap-4 text-center md:text-left translate-y-[15%]">
              ...
              >
                ...
                <h2 className="text-4xl sm:text-5xl md:text-7xl font-black tracking-[4px] md:tracking-[8px] text-white uppercase leading-none">
                  GARAGE <span className="text-accent">GYM</span>
                </h2>
              </motion.div>
              ...
              <motion.p
                ...
                className="max-w-xl text-[10px] md:text-[12px] font-code text-white uppercase tracking-[0.4em] md:tracking-[0.6em] leading-loose"
              >
                Strategic Partnership: Engineering elite fitness experiences through heavy-duty digital transformation and performance tracking systems.
              </motion.p>
        ...
        {scene === 8 && (
          ...
          >
            <div className="flex flex-col items-center md:items-start gap-4 text-center md:text-left translate-y-[15%]">
              ...
              >
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-white/10 flex items-center justify-center border border-white/20">
                  <Code className="text-accent w-6 h-6 md:w-8 md:h-8" />
                </div>
                <h2 className="text-4xl sm:text-5xl md:text-7xl font-black tracking-[4px] md:tracking-[8px] text-white uppercase leading-none">
                  SCRIPT <span className="text-accent">SERVICES</span>
                </h2>
              </motion.div>
              ...
              <motion.p
                ...
                className="max-w-xl text-[10px] md:text-[12px] font-code text-white uppercase tracking-[0.4em] md:tracking-[0.6em] leading-loose"
              >
                Strategic Partnership: Powering global enterprises with hyper-scalable automation, secure API logic, and intelligent script architectures.
              </motion.p>
