      ...
      <div className="fixed inset-0 z-10 overflow-hidden pointer-events-none">
        ...
        >
          <div className="text-center relative flex flex-col items-center">
            ...
            {/* TAGLINE & SOCIALS - Positioned further down to be "under the planet" */}
            <div className="mt-20 md:mt-32 flex flex-col items-center">
              <motion.p 
                initial={{ opacity: 0 }}
                animate={{ opacity: 0.9 }}
                transition={{ delay: 1, duration: 2 }}
                className="font-code tracking-[0.8em] text-accent uppercase text-center text-[10px] md:text-sm mb-12 glow-purple"
              >
                Start Like a Pro
              </motion.p>
              ...
              <motion.div
                  ...
                  className="flex justify-center space-x-10 pointer-events-auto"
              >
